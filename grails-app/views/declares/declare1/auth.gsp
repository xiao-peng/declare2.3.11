            ...
            <form action='${postUrl}' class="form-horizontal" method='post' id='loginForm' >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6" style="color: #fff;text-align: right;">
                        <a href="${request.contextPath}/login/register.html" style="color: white"><g:message code="system.login.register.label" default="Register" /></a> |
                        <a href="${request.contextPath}/login/forgetPass.html" style="color: white"><g:message code="system.login.forget.password.label" default="Forget passowrd" /></a>
                    </div>
                </div>
                <div class="form-group">
