...
<ul class="breadcrumb">
    ...
    <li class="active"><g:message code="default.baseRoleSet.label" default="BaseRoleSet"/></li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span><g:message code="default.baseRoleSet.label" default="BaseRoleSet"/></h2>
</div>
<!-- END PAGE TITLE -->
...
<div class="row box animated active" id="box-list">
    ...
    <table id="table" data-toolbar="#toolbar" data-toggle="table"
           data-url="${request.contextPath}/baseRole/json" data-cache="false"
        ...
        <tr>
            ...
            <th data-field="authority" data-sortable="true" >角色权限</th>
            <th data-field="description" data-sortable="true">中文描述</th>
