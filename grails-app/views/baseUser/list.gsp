...
<ul class="breadcrumb">
    ...
    <li class="active"><g:message code="default.allUser.label" default="AllUser"/></li>
</ul>
<!-- END BREADCRUMB -->
...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span><g:message code="default.allUser.label" default="AllUser"/></h2>
</div>
<!-- END PAGE TITLE -->
...
<div class="row box animated active" id="box-list">
    ...
    <table id="table" data-toolbar="#toolbar" data-toggle="table"
           data-url="${request.contextPath}/baseUser/json" data-cache="false"
        ...
        <tr>
            ...
            <th data-field="firstName" data-sortable="true" >名</th>
            <th data-field="enabled" data-sortable="true" >是否启用</th>
